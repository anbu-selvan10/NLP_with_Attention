...
llm = GoogleGenerativeAI(model="models/text-bison-001", google_api_key="//pw", temperature=0.1)
...
print(db_chain.invoke("How much Anbu@2534 save for gas in April 2024?"))